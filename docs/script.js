...
// hamburger menu
var menuTrigger = document.querySelector('.header__hamburger');
...
var dropInputs = document.querySelectorAll('.drop__check');
var dropAll = document.querySelector('.drop__all');
var dropHeader = document.querySelector('.drop__title--name');
var dropValue = document.querySelector('.drop__title--value');
var dropTitle = [];
dropInputs.forEach(function (el) {
...
var dropHeadline = document.querySelector('.drop__title');
var dropMenu = document.querySelector('.drop__expand');
var dropError = document.querySelector('.form__error--expand');
dropHeadline.addEventListener('click', function () {
...
var notifyTitle = document.querySelector('.notify__title');
var notifyList = document.querySelector('.notify__list');
var notifyRadios = document.querySelectorAll('.notify__radio');
var notifyItems = document.querySelectorAll('.notify__item');
notifyTitle.addEventListener('click', function () {
  notifyTitle.classList.toggle('notify__title--opened');
  notifyList.classList.toggle('notify__list--opened');
});
notifyRadios.forEach(function (el) {
  el.addEventListener('change', function () {
    ...
    notifyItems.forEach(function (el) {
