...
/* harmony import */ var _modules_hamburger__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/hamburger */ "./src/js/modules/hamburger.js");
/* harmony import */ var _modules_inputs__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/inputs */ "./src/js/modules/inputs.js");
/* harmony import */ var _modules_checkboxes__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./modules/checkboxes */ "./src/js/modules/checkboxes.js");
/* harmony import */ var _modules_notify__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./modules/notify */ "./src/js/modules/notify.js");
/* harmony import */ var _modules_popup__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./modules/popup */ "./src/js/modules/popup.js");
/* harmony import */ var _modules_popup__WEBPACK_IMPORTED_MODULE_16___default = /*#__PURE__*/__webpack_require__.n(_modules_popup__WEBPACK_IMPORTED_MODULE_16__);
...
swiper__WEBPACK_IMPORTED_MODULE_11__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_11__["Navigation"], swiper__WEBPACK_IMPORTED_MODULE_11__["Pagination"]]);
var mySwiper = new swiper__WEBPACK_IMPORTED_MODULE_11__["default"]('.swiper-container', {
  loop: true,
  pagination: {
...
var menu = new _modules_hamburger__WEBPACK_IMPORTED_MODULE_12__["Hamburger"]('.header__hamburger', '.header__menu');
menu.init(); //contacts inputs

var inputs = new _modules_inputs__WEBPACK_IMPORTED_MODULE_13__["Inputs"]('.form__input');
inputs.init(); //dropdown checkboxes

var checkboxes = new _modules_checkboxes__WEBPACK_IMPORTED_MODULE_14__["Checks"]();
checkboxes.init(); //notify opening

var notify = new _modules_notify__WEBPACK_IMPORTED_MODULE_15__["Notify"]();
notify.init(); //scroll
...
var Checks = /*#__PURE__*/function () {
  ...
  _createClass(Checks, [{
    ...
    value: function initCheckboxes() {
      ...
      this.$dropInputs.forEach(function (el) {
        el.addEventListener('change', function () {
          _this.rerenderInputs.call(_this);
        });
      });
    }
  }, {
    key: "initAllBtn",
    value: function initAllBtn() {
      var _this2 = this;

      this.$dropAll.addEventListener('click', function () {
        _this2.selectAll.call(_this2);
      });
    }
  }, {
    key: "initDropClose",
    value: function initDropClose() {
      var _this3 = this;
    ...
    key: "initDropToggle",
    value: function initDropToggle() {
      var _this4 = this;

      this.$dropHeadline.addEventListener('click', function () {
        _this4.toggleDrop();
      });
    }
  }, {
    key: "initProgramBtns",
    value: function initProgramBtns() {
      var _this5 = this;

      this.$programBtns.forEach(function (el) {
        el.addEventListener('click', function (e) {
          ...
          _this5.openDrop.call(_this5);

          _this5.$dropInputs.forEach(function (el) {
            if (el.id === blockID) {
              el.setAttribute("checked", "true");

              _this5.rerenderInputs.call(_this5);
            }
          });
        });
      });
    ...
    key: "rerenderInputs",
    value: function rerenderInputs() {
      var _this6 = this;

      this.dropTitle = [];
      this.$dropInputs.forEach(function (elem) {
        if (elem.checked) {
          _this6.dropTitle.push(elem.dataset.value);
        }
      });
...
var Hamburger = /*#__PURE__*/function () {
  function Hamburger(trigger, menu) {
...
var Notify = /*#__PURE__*/function () {
  ...
  _createClass(Notify, [{
    ...
    value: function init() {
      ...
      this.$notifyTitle.addEventListener('click', function () {
        _this.$notifyTitle.classList.toggle('notify__title--opened');

        _this.$notifyList.classList.toggle('notify__list--opened');
      });
      this.$notifyRadios.forEach(function (el) {
        el.addEventListener('change', function () {
          _this.$notifyTitle.classList.remove('notify__title--opened');

          _this.$notifyList.classList.remove('notify__list--opened');

          _this.$notifyTitle.textContent = el.dataset.value;

          _this.$notifyItems.forEach(function (el) {
            return el.classList.remove('notify__item--active');
          });
      ...
      document.body.addEventListener('click', function (e) {
        if (e.target != _this.$notifyList && e.target != _this.$notifyTitle) {
          _this.$notifyTitle.classList.remove('notify__title--opened');
